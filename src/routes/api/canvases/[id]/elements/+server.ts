...
// Ticket #527: Elemente eines Canvas — nur 'text'/'frame' sind in diesem
// Ticket anlegbar (image/sketch/ref kommen in Folgetickets, das DB-CHECK in
// V12__Canvas_Schema.sql erlaubt sie zwar schon, die Zod-Validierung hier
// bewusst noch nicht).
const createElementSchema = z.object({
	type: z.enum(['text', 'frame']),
	content: z.object({
